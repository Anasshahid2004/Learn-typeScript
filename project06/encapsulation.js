...
var Country = /** @class */ (function () {
    function Country(name, language, population, populationGrowRate, _statePrivacy, _leader) {
        this.name = name;
...
var OICCountry = /** @class */ (function (_super) {
    ...
    function OICCountry(name, language, population, populationGrowRate, statePrivacy, leader) {
        return _super.call(this, name, language, population, populationGrowRate, statePrivacy, leader) || this;
    }
